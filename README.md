...
The scripts aggregate data from all municipalities in Brazil.
...
The script below analyzes and displays which regions are on track to meet the 
WHO's maternal and child mortality reduction targets:
...
```text
01_mortality_indicators_opt_llm.R
02_who_goal_progress_opt_llm.R
```
Optimize the initial codes using LLM, making it shorter and faster to run.
